...
protected:
    ...
    AndQuery(const AndQuery& orig) = default;
    AndQuery& operator=(const AndQuery& rhs) = default;


    AndQuery(AndQuery&& orig) = default;
    AndQuery& operator=(AndQuery&& rhs) = default;
    ...
    AndQuery* clone() && override {return new AndQuery(std::move(*this));}
private:
